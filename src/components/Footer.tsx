    ...
    <footer className="bg-[#1A1F2C] text-white">
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="mt-8 text-gray-400 text-sm leading-relaxed">
          <p>
            We provide Air Conditioners On Rent like Window AC 1ton on Rent, Window AC 1.5ton On Rent, 
            Window AC 2 Ton On Rent, Split AC 1ton On Rent, Split AC 1.5Ton On Rent, Split AC 2Ton On Rent 
            And Other Appliances Refrigerator & Washing Machine On Rent Available. Special Rental Appliances 
            For Winter period Oil Filled Heater On Rent 9Fin to 13Fin Oil Heater On Rent available And Water 
            Geyser On Rent Also available. Installation & Maintenance Covered Free off cost. Service Area: 
            All Gurugram & All Sohna City.
          </p>
        </div>
